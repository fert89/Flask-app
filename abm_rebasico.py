...
class ABM_rebasico:
    ...
    def conectar(self):
        ...
        '''
        try:
            self._conn = mdb.connect(host=self._host, user=self._user, passwd=self._passwd, db=self._dbase)
            return True
        except:
    ...
    def agregar(self, datos):
        ...
        try:
            ...
            for artist, otro in datos:
                ...
                # esto no se hace NUNCA asi, porque es vulnerable a
                # "SQL injection exploit" Lo vemos luego
